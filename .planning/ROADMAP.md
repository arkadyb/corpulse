...
- [ ] 17-01: Add additive helper functions to `corpulse.integrations.qdrant` while preserving lazy imports
- [ ] 17-02: Add deterministic and idempotency-focused helper tests
